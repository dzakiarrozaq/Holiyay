...
public class InputJawaBaratActivity extends AppCompatActivity implements View.OnClickListener {
    // Define Views
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_jawa_barat);
    ...
    private void addEntry() {
        ...
        class AddEntry extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(InputJawaBaratActivity.this, "Menambahkan...", "Tunggu...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(InputJawaBaratActivity.this, s, Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                return rh.sendPostRequest(konfigurasi.URL_ADD_JABAR, params);
            }
        }
    ...
    public void onClick(View v) {
        if (v == buttonAdd) {
            addEntry();
            startActivity(new Intent(this, JawaBaratActivity.class));
        }
        if(v==buttonView){
