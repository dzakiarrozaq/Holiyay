...
public class InputJakartaActivity extends AppCompatActivity implements View.OnClickListener {
    // Define Views
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_jakarta);
    ...
    private void addEntry() {
        ...
        class AddEntry extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(InputJakartaActivity.this, "Menambahkan...", "Tunggu...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(InputJakartaActivity.this, s, Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                return rh.sendPostRequest(konfigurasi.URL_ADD_JAKARTA, params);
            }
        }
    ...
    public void onClick(View v) {
        if (v == buttonAdd) {
            addEntry();
            startActivity(new Intent(this, JakartaActivity.class));
        }
        if(v==buttonView){
