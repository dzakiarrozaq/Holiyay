...
import android.example.utsmobapps.input.InputJawaBaratActivity;
...
public class JawaBaratActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JawaBaratActivity.this, MenuActivity.class);
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(JawaBaratActivity.this, InputJawaBaratActivity.class);
                startActivity(intent);
            }
        });
    ...
    private class FetchDataTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            return requestHandler.sendGetRequest(konfigurasi.URL_GET_ALL_WISATAJABAR);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Log.e("JawaBaratActivity", "Error parsing JSON data.", e);
            }
        }
    }
