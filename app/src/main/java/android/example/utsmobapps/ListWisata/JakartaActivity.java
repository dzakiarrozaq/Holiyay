...
import android.example.utsmobapps.input.InputJakartaActivity;
...
public class JakartaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("Tempat Wisata Jakarta");
        }
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(JakartaActivity.this, InputJakartaActivity.class);
                startActivity(intent);
            }
        });

        // Fetch data from the server
        new JakartaActivity.FetchDataTask().execute();
    ...
    private class FetchDataTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            String s = requestHandler.sendGetRequest(konfigurasi.URL_GET_ALL_WISATAJAKARTA);
            return s;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Log.e("JakartaActivity", "Error parsing JSON data.", e);
            }
        }
